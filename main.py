...
if page == "🏠 דף הבית":
    ...
    if not st.session_state.all_sheets:
        ...
        manual_content = {
            ...
            "שאלת תת חקר 2": {
                "findings": "גרף הפיזור מציג פיזור רחב וקיצוני בחברות קטנות, לעומת יציבות יחסית בקרב חברות הענק. קו המגמה השטוח בגרף מוכיח באופן ויזואלי כי אין קשר ישיר או עקבי בין גודל החברה לקצב צמיחתה. הממצאים מראים שווי שוק גבוה אינו מבטיח צמיחה מהירה, וכי אין מתאם ליניארי חיובי חזק בין המשתנים ב-S&P 500.",
                "conclusions": "אין קשר חיובי חזק בין גודל החברה לקצב צמיחתה ולכן שווי שוק לא בהכרח מנבא תשואה גבוהה."
            },
            "שאלת תת חקר 3": {
                "findings": "מבחינת פיזור הנתונים בגרף, ניתן לראות כי קיים קשר חיובי בין שווי השוק של הסקטור לבין קצב הצמיחה שלו, אך קשר זה אינו אחיד לכל אורך הציר. בסקטורים בעלי שווי שוק נמוך (החלק השמאלי של הגרף), קיימת תנודתיות גבוהה מאוד: חלקם מציגים את הצמיחה המהירה ביותר במדד (מעל 7%), בעוד שאחרים מציגים צמיחה שלילית. ככל שנעים ימינה על ציר השווי, קו המגמה מצביע על עלייה מתונה בצמיחה הממוצעת. הסקטורים הגדולים ביותר בנתונים אלו מצליחים לשמור על קצב צמיחה יציב וגבוה יחסית (סביב ה-5%), מה שמעניק להם עדיפות על פני הממוצע הכללי של הסקטורים הקטנים יותר. קו המגמה העולה מאשר כי במצב השוק הנוכחי, לגודל יש יתרון מסוים בייצור צמיחה עקבית.",
